      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-24">
          ...
          <div className="flex-shrink-0 flex items-center">
            <Link href="/" className="flex flex-col">
              <span className="text-4xl font-black text-[#E6C875] tracking-tight flex items-center gap-1">
                ALZAA <span className="text-2xl">🧁</span>
              </span>
              <span className="text-white tracking-[0.2em] text-xs uppercase mt-0.5">Food Corner</span>
              <span className="text-gray-400 text-[0.6rem] uppercase tracking-widest mt-1">Premium Bakery & Sweets</span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex flex-col items-end gap-2">
            ...
            <a href="https://wa.me/918178708376?text=Hello%20Alzaa%20Food%20Corner,%20I%20want%20to%20place%20an%20order." target="_blank" rel="noopener noreferrer" className="bg-[#25D366] text-white px-5 py-2 rounded-full font-bold text-sm shadow-lg shadow-[#25D366]/30 hover:shadow-[#25D366]/50 hover:bg-[#20b858] transition-all flex items-center gap-2">
